...
import { Popover, Menu, Icon, Avatar, Drawer, Button, Input } from 'antd';
...
class LayoutUsers extends React.Component {
    ...
    render() {
        const text = <a>Sebastisn Calderon</a>;
        const content = (
            <div>
                <div>
                    <a>Ayuda</a>
